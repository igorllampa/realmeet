...
public class ReportCreationService {
    ...
    public ReportCreationService(ReportHandlerResolver reportHandlerResolver, ReportDispatcherService reportDispatcherService) {
    ...
    public void createAllocationReport(LocalDate dateFrom, LocalDate dateTo, String email, String reportFormatStr){
        var reportData = AllocationReportData
            .newBuilder()
            .dateFrom(dateFrom)
            .dateTo(dateTo)
            .email(email)
